...
const Positions = ({ auth, positions, positionsPerPage }) => {
  ...
  return (
    <AuthenticatedLayout user={auth.user} header={<h2 className="font-medium text-xl text-gray-800 dark:text-gray-50 leading-tight">Manage Candidate Positions</h2>} >
