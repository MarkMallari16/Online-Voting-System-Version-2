...
export function PartylistTable({ partylists, partylistsPerPage }) {
  ...
  const [selectedTab, setSelectedTab] = useState("partylist_editor");
  ...
  return (
    <div>
      <div className="flex justify-end">
        <Tabs value={selectedTab} className="w-full md:w-80" onChange={handleSelectedTab}>
          <TabsHeader>
              ...
              <div className="flex justify-end ">
                <Dropdown>
                  ...
                  <Dropdown.Content align="right" width="48">
                    ...
                    <Dropdown.Link href="#">Dropdown Item 2</Dropdown.Link>
                    <Dropdown.Link href="#">Dropdown Item 3</Dropdown.Link>
                  </Dropdown.Content>
                </Dropdown>
              </div>
              <div>
