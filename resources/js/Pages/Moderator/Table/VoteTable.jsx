...
function ShowVoteDetailsModal(id, selectedVote, open, handleOpen, handleClose) {
                ...
                <CardBody className="overflow-scroll px-0">
                    <Tabs value={voteCategory} checked={TABS.value === voteCategory}>
                        ...
                        <TabsBody>
                            ...
                            <ShowVoteDetailsModal id={id} selectedVote={selectedVote} open={open} handleOpen={handleOpen} handleClose={handleClose} />
                        </TabsBody>
                    </Tabs>
                </CardBody>
