...
const HeroComponent = () => {
    return (
        <div className="sm:mt-5 sm:mb-40 md:my-24 lg:mt-5 mt-24 grid grid-cols-1 lg:grid-cols-2 place-items-center items-center flex-col-reverse sm:flex-col-reverse md:flex-row  gap-5 sm:gap-24  mx-5 sm:mx-10  md:mx-20"
        ...
        >
            <div >
                <div>
                    ...
                    <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-center  md:text-left mb-3">ONLINE VOTING <span className='text-blue-600'>SYSTEM</span></h1>
                </div>
            ...
            <img src={Cover} alt="hero-section" className="sm:w-[90%]  w-full h-full hidden sm:hiddent md:block drop-shadow-xl" />
        </div>
    )
}
