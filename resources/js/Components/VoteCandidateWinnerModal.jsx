                    ...
                    <div className='mt-5 mb-6 sm:mb-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-2 text-sm md:text-base'>
                        {
                            ...
                            Object.keys(candidateWinners).map((position, id) => (
                                <div key={id}>
                                    ...
                                    <div className='flex items-center ring-1 ring-inset ring-gray-300 bg-gray-50 rounded-lg py-5 px-4 gap-3 w-full md:w-auto'>
                                        <div>
                                            <Avatar src={`storage/${candidateWinners[position].candidate_profile}`}></Avatar>
                                        </div>
                                        <div>
                                            <div className='text-gray-900'>{`${candidateWinners[position].candidate_full_name}`}</div>
                                        ...
                                        <div className='flex-1 flex justify-end items-center gap-1 flex-wrap text-blue-600'>
