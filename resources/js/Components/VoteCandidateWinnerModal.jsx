            ...
            <div className='px-6 py-4 dark:bg-[#252525]'>
                <div className='flex justify-between items-center mb-5'>
                    <div className='flex items-center gap-3 '>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-white w-10 h-10 bg-blue-500 dark:bg-gray-800 p-2 rounded-md">
                    ...
                    <div className='p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-all ease-in-out duration-200 cursor-pointer dark:text-gray-50' onClick={onClose}>
