...
const BarChartAllCandidates = ({ voteCounts, positionNames }) => {
  ...
  return (
    <div className='mt-5 bg-white dark:bg-[#252525] dark:text-gray-50 w-full p-10 rounded-lg ring-1 ring-gray-300 dark:ring-gray-800'>
