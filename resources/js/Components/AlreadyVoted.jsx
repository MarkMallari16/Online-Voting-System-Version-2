                  ...
                  <li key={vote.id} className="mb-3 border-2 border-black p-3 rounded-md w-full">
                    <div className="flex justify-between items-center ">
                      <div className='flex gap-3'>
                        ...
                        <div>
                          <div className='font-medium'>{`${vote.candidate.first_name} ${vote.candidate.middle_name} ${vote.candidate.last_name}`}</div>
                      ...
                      <div className='text-blue-gray-800'>{getPositionName(vote.candidate.position_id)}</div>
                    </div>
                  </li>
                ))}
              </ul>
